...
cw.get_balance(w3, address="0x3CF20155A524fc854532CA3DC8297A18045B821B")
...
if st.sidebar.button("Send Transaction"):
    ...
    transaction_hash = cw.send_transaction(w3, account=account, to = candidate_address, wage=wage)
